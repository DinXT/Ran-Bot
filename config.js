...
function kyun(seconds){
  ...
  return `Runtime\n${pad(hours)}H ${pad(minutes)}M ${pad(seconds)}S`
					...
					teks = `${kyun(runtime)}`
global.owner = ['6287819654911'] // Put your number here
global.fake = ['6287819654911', '0', '0', '0']
global.fakeNum = ['6287819654911','0' ]
global.mods = ['6281380674817'] // Want some help?
global.prems = ['6281380674817'] // Premium user has unlimited limit
...
// Sticker WM
global.botwm = `DinXYZ`//UBAH JADI NAMAMU
global.botdate = ` ${time}\n ${week} ${date}`
global.packname =  `DinXYZ`
global.author = `Stickers`
global.wait = 'Bot bimlek 😅'
